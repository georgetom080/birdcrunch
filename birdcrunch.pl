...
# Survey Name
our $surveyname =	"Parambikulam TR Bird Survey, 2008.";
our $areaname   =	"Parambikulam TR";
our $state      =	"KL";

# Output filename
our $output_file =	"parambikulam_analysis_gt.xls";
...
our $datasheet_file         = "parambikulam_datasheet_edited_sorted.xls";
our $datasheet_camp_col     = "2";
our $datasheet_date_col     = "3";
our $datasheet_transect_col = "4";
our $datasheet_time_col     = "5";
our $datasheet_bird_col     = "7";
our $datasheet_num_col      = "8";
our $datasheet_db1_col      = "9"; # Distance Band
our $datasheet_db2_col      = "10";
our $datasheet_db3_col      = "11";
our $datasheet_db4_col      = "12";
our $datasheet_habitat_col  = "13";
our $datasheet_remarks_col  = "14";
our $datasheet_observers_col= "15";

# Filename and column positions of checklist file
our $checklist_file        = "parambikulam_checklist_edited.xls";
		...
		for my $row ($row_min .. $row_max) {
			...
			for my $col ($col_min .. $col_max) {
				...
				if ($cell) {
			      ...
			      # Print a warning if the entry in the datasheet has no match in the lookup
			      unless (grep(/^$row_contents[$checklist_bird_col-1]$/, @bird_names)) {
						  push @checklist_birdname_nomatch, $row_contents[$checklist_bird_col-1], unless (grep(/^$row_contents[$checklist_bird_col-1]$/, @checklist_birdname_nomatch));
						}
					}
				} else {
					push @row_contents, "-";
